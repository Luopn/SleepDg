package com.jx.sleep_dg.view.circlebar;
...
import com.jx.sleep_dg.BuildConfig;
import com.jx.sleep_dg.R;

/**
 * Created by 覃微 on 2018/5/21.
 */
...
public class CircleProgressBar extends View {
    ...
    private int[] mGradientColors = {Color.parseColor("#191b32"),
            Color.parseColor("#6669ed"),Color.parseColor("#ffffff")};
    //当前进度，[0.0f,1.0f]
    ...
    private void init(Context context, AttributeSet attrs) {
        mContext = context;
        mDefaultSize = MiscUtil.dipToPx(mContext, CircleConstant.DEFAULT_SIZE);
    ...
    private void initAttrs(AttributeSet attrs) {
        ...
        mValueSize = typedArray.getDimension(R.styleable.CircleProgressBar_valueSize, CircleConstant.DEFAULT_VALUE_SIZE);
        ...
        mUnitSize = typedArray.getDimension(R.styleable.CircleProgressBar_unitSize, CircleConstant.DEFAULT_UNIT_SIZE);

        mArcWidth = typedArray.getDimension(R.styleable.CircleProgressBar_arcWidth, CircleConstant.DEFAULT_ARC_WIDTH);
        mStartAngle = typedArray.getFloat(R.styleable.CircleProgressBar_startAngle, CircleConstant.DEFAULT_START_ANGLE);
        mSweepAngle = typedArray.getFloat(R.styleable.CircleProgressBar_sweepAngle, CircleConstant.DEFAULT_SWEEP_ANGLE);

        mBgArcColor = typedArray.getColor(R.styleable.CircleProgressBar_bgArcColor, Color.WHITE);
        mBgArcWidth = typedArray.getDimension(R.styleable.CircleProgressBar_bgArcWidth, CircleConstant.DEFAULT_ARC_WIDTH);
        ...
        mAnimTime = typedArray.getInt(R.styleable.CircleProgressBar_animTime, CircleConstant.DEFAULT_ANIM_TIME);
