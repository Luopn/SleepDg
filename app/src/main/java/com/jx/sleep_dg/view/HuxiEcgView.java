...
public class HuxiEcgView extends View{
...
//   private Canvas canvas1;
    ...
    public HuxiEcgView(Context context, AttributeSet attrs) {
        super(context, attrs);
        init();
    }

    public HuxiEcgView(Context context, AttributeSet attrs, int defStyleAttr) {
    ...
    private void init(){
        ...
        electrocarPaint.setColor(Color.WHITE);
    ...
    protected void onDraw(Canvas canvas) {
        ...
        if (xiaochu){
            ...
            canvas.drawColor(Color.parseColor("#181b32"));
